...
// // //                 <Text style={[styles.th, { width: 140 }]}>DOCUMENT TYPE</Text>
...
// // //       <Text style={styles.inputLabel}>Document Template *</Text>
// // //       <TextInput
...
// //   // -------------------------------------------------------------
// //   // SUBMIT FUNCTION FOR HR LETTER CREATION
// //   // -------------------------------------------------------------
// //   const handleCreateSubmit = async () => {
// //     if (!formLetterType || !formSubject) {
// //       Alert.alert('Validation Error', 'Please select or enter a Letter Type and Subject.');
...
// //   // Selected Letter Data for Preview Modal
// //   const [selectedLetter, setSelectedLetter] = useState<EmployeeDocument | null>(null);
// //   const [, setPreviewData] = useState<DocumentTemplate | null>(null);
...
// //         {/* CONTROLS TOOLBAR (VERTICAL WRAP - NO HORIZONTAL SCROLL) */}
// //         <View style={styles.controlsSection}>
// //           <View style={styles.searchBox}>
// //             <Feather name="search" size={16} color="#9E9E9E" />
// //             <TextInput
...
// //             <TouchableOpacity style={styles.dropdownBtn} onPress={() => setShowTypeDropdown(true)}>
// //               <Text style={styles.dropdownText} numberOfLines={1}>{selectedType}</Text>
// //               <Feather name="chevron-down" size={14} color="#666" />
// //             </TouchableOpacity>

// //             <TouchableOpacity style={styles.dropdownBtn} onPress={() => setShowStatusDropdown(true)}>
// //               <Text style={styles.dropdownText} numberOfLines={1}>{selectedStatus}</Text>
// //               <Feather name="chevron-down" size={14} color="#666" />
// //             </TouchableOpacity>

// //             <TouchableOpacity style={styles.dateBtn}>
// //               <Feather name="calendar" size={14} color="#666" />
// //               <Text style={styles.dateText} numberOfLines={1}>01 May 2026 – 31 May 2026</Text>
// //             </TouchableOpacity>
...
// //   metricIconBoxGreen: { width: 32, height: 32, borderRadius: 6, backgroundColor: '#E8F5E9', alignItems: 'center', justifyContent: 'center' },
// //   metricIconBoxRed: { width: 32, height: 32, borderRadius: 6, backgroundColor: '#FFEBEE', alignItems: 'center', justifyContent: 'center' },
// //   metricLabel: { fontSize: 10, color: '#78909C', fontWeight: 'bold' },
// //   metricValue: { fontSize: 16, fontWeight: 'bold', color: '#263238', marginVertical: 2 },
// //   metricSubtext: { fontSize: 10, color: '#90A4AE' },

// //   // CONTROLS (NO HORIZONTAL SCROLL)
// //   controlsSection: { paddingHorizontal: 12, marginBottom: 12 },
// //   searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderWidth: 1, borderColor: '#ECEFF1', borderRadius: 8, paddingHorizontal: 12, height: 40, marginBottom: 10 },
// //   searchInput: { flex: 1, marginLeft: 8, fontSize: 13, color: '#263238' },
// //   filterGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, alignItems: 'center' },
// //   dropdownBtn: { flex: 1, minWidth: '45%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFF', borderWidth: 1, borderColor: '#ECEFF1', borderRadius: 8, paddingHorizontal: 10, height: 38 },
// //   dropdownText: { fontSize: 12, color: '#37474F' },
// //   dateBtn: { flex: 2, minWidth: '60%', flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderWidth: 1, borderColor: '#ECEFF1', borderRadius: 8, paddingHorizontal: 10, height: 38, gap: 6 },
// //   dateText: { fontSize: 11, color: '#37474F' },
// //   toggleGroup: { flexDirection: 'row', backgroundColor: '#ECEFF1', borderRadius: 8, padding: 2, height: 38, alignItems: 'center' },
// //   toggleBtn: { paddingHorizontal: 10, height: 34, justifyContent: 'center', alignItems: 'center', borderRadius: 6 },
// //   activeToggle: { backgroundColor: '#1565C0' },

// //   // CARDS & TABLE
// //   cardsContainer: { paddingHorizontal: 12, gap: 10 },
// //   itemCard: { backgroundColor: '#FFF', borderRadius: 8, padding: 12, borderWidth: 1, borderColor: '#ECEFF1' },
// //   cardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
// //   userInfo: { flexDirection: 'row', alignItems: 'center', gap: 10 },
// //   avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#E3F2FD', alignItems: 'center', justifyContent: 'center' },
// //   avatarText: { color: '#1565C0', fontWeight: 'bold', fontSize: 12 },
// //   userName: { fontSize: 14, fontWeight: 'bold', color: '#263238' },
// //   userRole: { fontSize: 11, color: '#78909C' },
// //   cardBodyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginVertical: 12 },
// //   letterTag: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#F0F4F8', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4 },
// //   letterTagText: { fontSize: 12, color: '#0047AB', fontWeight: '500' },
// //   statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
// //   statusBadgeText: { fontSize: 11, fontWeight: 'bold' },
// //   cardFooter: { borderTopWidth: 1, borderTopColor: '#F5F5F5', paddingTop: 8, flexDirection: 'row', justifyContent: 'space-between' },
// //   dateLabel: { fontSize: 11, color: '#90A4AE' },
// //   dateValue: { fontSize: 11, color: '#37474F', fontWeight: '500' },

// //   // TABLE STYLES
// //   tableScroll: { paddingHorizontal: 12 },
// //   tableHeader: { flexDirection: 'row', backgroundColor: '#ECEFF1', paddingVertical: 10, paddingHorizontal: 8, borderRadius: 6 },
// //   th: { fontSize: 11, fontWeight: 'bold', color: '#455A64' },
// //   tableRow: { flexDirection: 'row', backgroundColor: '#FFF', paddingVertical: 12, paddingHorizontal: 8, borderBottomWidth: 1, borderBottomColor: '#ECEFF1', alignItems: 'center' },
// //   td: { flexDirection: 'row', alignItems: 'center' },
// //   avatarSmall: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#E3F2FD', alignItems: 'center', justifyContent: 'center' },
// //   avatarTextSmall: { color: '#1565C0', fontWeight: 'bold', fontSize: 10 },
// //   tdBold: { fontSize: 12, fontWeight: 'bold', color: '#263238' },
// //   tdSub: { fontSize: 10, color: '#78909C' },
// //   tdText: { fontSize: 12, color: '#37474F' },
// //   tdActions: { alignItems: 'center' },

// //   // MODALS
// //   modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' },
// //   dropdownMenu: { backgroundColor: '#FFF', borderRadius: 8, width: '80%', padding: 8 },
// //   dropdownMenuItem: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 12 },
// //   menuItemText: { fontSize: 14, color: '#37474F' },
// //   activeMenuText: { color: '#0047AB', fontWeight: 'bold' },

// //   modalHeaderDark: { backgroundColor: '#0A1E3F', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14 },
// //   formSectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#263238', marginBottom: 12 },
// //   inputLabel: { fontSize: 12, fontWeight: 'bold', color: '#455A64', marginTop: 10, marginBottom: 4 },
// //   formInput: { borderWidth: 1, borderColor: '#CFD8DC', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 8, fontSize: 13, color: '#263238' },

// //   modalFooter: { flexDirection: 'row', justifyContent: 'flex-end', padding: 16, gap: 10, borderTopWidth: 1, borderTopColor: '#ECEFF1' },
// //   closeBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 6, borderWidth: 1, borderColor: '#CFD8DC' },
// //   closeBtnText: { color: '#455A64', fontSize: 13, fontWeight: 'bold' },
// //   submitBtn: { backgroundColor: '#1565C0', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 6, justifyContent: 'center', alignItems: 'center' },
// //   submitBtnText: { color: '#FFF', fontSize: 13, fontWeight: 'bold' },

// //   previewHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#ECEFF1' },
// //   previewCard: { backgroundColor: '#FFF', padding: 16, borderRadius: 8, borderWidth: 1, borderColor: '#ECEFF1' },
// //   companyTitle: { fontSize: 18, fontWeight: 'bold', color: '#0047AB', textAlign: 'center' },
// //   divider: { height: 1, backgroundColor: '#ECEFF1', marginVertical: 12 },
// //   dynamicLetterText: { fontSize: 13, color: '#37474F', lineHeight: 20 },
// //   actionBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 6, borderWidth: 1, borderColor: '#CFD8DC' },
// //   actionBtnText: { fontSize: 12, fontWeight: 'bold', color: '#37474F' },
// // });
...
//   const [showCreateModal, setShowCreateModal] = useState<boolean>(false);
//   const [showPreviewModal, setShowPreviewModal] = useState<boolean>(false);
//   const [showFormTypeDropdown, setShowFormTypeDropdown] = useState<boolean>(false);
...
//   const [formEmployee, setFormEmployee] = useState('Don Bosko');
//   const [formDesignation, setFormDesignation] = useState('Software Engineer');
//   const [formLetterType, setFormLetterType] = useState('Offer Letter');
//   const [formSubject, setFormSubject] = useState('Job Offer - Software Engineer');
//   const [formStatus, setFormStatus] = useState('Pending Approval');
...
//   // SUBMIT CREATION
//   const handleCreateSubmit = async () => {
//     if (!formLetterType || !formSubject || !formEmployee) {
...
//       setFormEmployee('Don Bosko');
//       setFormDesignation('Software Engineer');
//       setFormLetterType('Offer Letter');
//       setFormSubject('Job Offer - Software Engineer');
//       setFormStatus('Pending Approval');
...
//   // DYNAMIC LETTER TEMPLATES GENERATOR
//   const getDynamicLetterTemplate = (item: EmployeeDocument | null) => {
//     if (!item) return { bodyText: '', title: '' };

//     const employee = item.employeeName || 'Employee';
//     const designation = item.designation || 'Team Member';
//     const company = item.company_name || 'HDFC Bank';
//     const letterType = item.letterType || 'Offer Letter';
//     const formattedDate = formatDate(item.createdAt || new Date());
//     const department = item.department || 'Human Resources';
//     const location = item.location || 'Bommanahalli';
//     const joiningDate = item.joiningDate || '01-06-2026';
//     const ctc = item.ctc || '2,00,000';
...
//         return {
//           title: 'OFFER LETTER',
//           bodyText: `Date: ${formattedDate}\n\nDear ${employee},\n\nWe are pleased to offer you the position of ${designation} at ${company}. We are confident that your skills and experience will contribute significantly to our organization.\n\n• Department: ${department}\n• Location: ${location}\n• Joining Date: ${joiningDate}\n• Annual CTC: ${ctc}\n\nYour employment shall be governed by the standard policies and regulations of the company.\n\nWe look forward to welcoming you to our team.\n\nSincerely,\n\nHR Operations\n${company}`,
//         };

//       case 'Appointment Letter':
//         return {
//           title: 'APPOINTMENT LETTER',
//           bodyText: `Date: ${formattedDate}\n\nDear ${employee},\n\nFollowing your acceptance of our offer, we are pleased to formally appoint you as ${designation} at ${company}.\n\n• Department: ${department}\n• Work Location: ${location}\n• Effective Date: ${joiningDate}\n\nPlease return a signed copy of this appointment letter confirming your acceptance of the specified terms.\n\nSincerely,\n\nHR Operations\n${company}`,
//         };
...
//         return {
//           title: 'RELIEVING LETTER',
//           bodyText: `Date: ${formattedDate}\n\nDear ${employee},\n\nWith reference to your resignation, we hereby accept the same and relieve you from your duties as ${designation} at ${company} effective ${formattedDate}.\n\nAll company assets have been successfully returned and dues settled.\n\nSincerely,\n\nHR Operations\n${company}`,
//         };

//       case 'NDA Letter':
//         return {
//           title: 'NON-DISCLOSURE AGREEMENT',
//           bodyText: `Date: ${formattedDate}\n\nDear ${employee},\n\nAs an employee working as ${designation} in the ${department} department at ${company}, you agree to maintain complete confidentiality regarding all proprietary information, software, and trade secrets.\n\nFailure to comply with confidentiality rules may result in formal disciplinary or legal action.\n\nSincerely,\n\nHR Operations\n${company}`,
//         };

//       default:
//         return {
//           title: letterType.toUpperCase(),
//           bodyText: `Date: ${formattedDate}\n\nDear ${employee},\n\nThis is an official document regarding your role as ${designation} in ${department} at ${company}.\n\nYour employment shall be governed by the policies and regulations of the company.\n\nSincerely,\n\nHR Operations\n${company}`,
//         };
//     }
//   };
...
//  const handleDownloadPDF = async () => {
//   try {
//     // 1. Generate HTML string and temporary PDF file
//     const html = generateHTMLContent();
//     const { uri: tempUri } = await Print.printToFileAsync({ html });

//     // 2. Define target file path in internal document storage
//     const fileName = `${selectedLetter?.letterType?.replace(/\s+/g, '_') || 'Document'}_${Date.now()}.pdf`;
//     const targetPath = `${FileSystem.documentDirectory}${fileName}`;

//     // 3. Move file from temp cache to local document directory
...
//       // 4. Convert file path to content URI and trigger native file handler (View/Save)
...
//       });
//     } else {
//       Alert.alert('Download Complete', `PDF saved locally: ${fileName}`);
//     }
//   } catch (error) {
//     console.error('PDF Download Error:', error);
//     Alert.alert('Error', 'Failed to generate and save PDF locally.');
//   }
// };
...
//         typeof item.createdAt === 'number' || !isNaN(Number(item.createdAt))
...
//             <TextInput
//               style={styles.searchInput}
//               placeholder="Search letters by employee name, type..."
//               placeholderTextColor="#9E9E9E"
//               value={searchQuery}
//               onChangeText={setSearchQuery}
//             />
...
//       {/* FORM TYPE DROPDOWN MODAL */}
//       <Modal visible={showFormTypeDropdown} transparent animationType="fade">
//         <TouchableOpacity style={styles.modalOverlay} onPress={() => setShowFormTypeDropdown(false)}>
//           <View style={styles.dropdownMenu}>
//             <ScrollView style={{ maxHeight: 300 }}>
//               {letterTypes.filter(t => t !== 'All Types').map((type) => (
//                 <TouchableOpacity
//                   key={type}
//                   style={styles.dropdownMenuItem}
//                   onPress={() => {
//                     setFormLetterType(type);
//                     setShowFormTypeDropdown(false);
//                   }}>
//                   <Text style={[styles.menuItemText, formLetterType === type && styles.activeMenuText]}>
//                     {type}
//                   </Text>
//                   {formLetterType === type && <Feather name="check" size={14} color="#0047AB" />}
//                 </TouchableOpacity>
//               ))}
//             </ScrollView>
//           </View>
...
//           <ScrollView style={{ padding: 16 }}>
//             <Text style={styles.formSectionTitle}>HR Letter Details</Text>
...
//               onPress={() => setShowFormTypeDropdown(true)}
//             >
//               <Text style={{ color: formLetterType ? '#000' : '#9E9E9E' }}>
//                 {formLetterType || 'Select Letter Type'}
//               </Text>
//             </TouchableOpacity>
...
//   headerTitle: { color: '#FFF', fontSize: 18, fontWeight: 'bold' },
//   headerSubtitle: { color: '#90A4AE', fontSize: 12 },
//   createBtn: { backgroundColor: '#0047AB', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
//   createBtnText: { color: '#FFF', fontWeight: 'bold', fontSize: 13 },
//   metricsGrid: { flexDirection: 'row', flexWrap: 'wrap', padding: 8, justifyContent: 'space-between' },
//   metricCard: {
//     width: '48%',
//     backgroundColor: '#FFF',
//     padding: 12,
...
//     elevation: 2,
//   },
//   metricIconBoxBlue: { backgroundColor: '#E3F2FD', padding: 8, borderRadius: 6, marginRight: 10 },
//   metricIconBoxOrange: { backgroundColor: '#FFF3E0', padding: 8, borderRadius: 6, marginRight: 10 },
//   metricIconBoxGreen: { backgroundColor: '#E8F5E9', padding: 8, borderRadius: 6, marginRight: 10 },
//   metricIconBoxRed: { backgroundColor: '#FFEBEE', padding: 8, borderRadius: 6, marginRight: 10 },
//   metricLabel: { fontSize: 10, color: '#78909C', fontWeight: 'bold' },
//   metricValue: { fontSize: 18, fontWeight: 'bold', color: '#263238' },
//   metricSubtext: { fontSize: 10, color: '#90A4AE' },
//   controlsSection: { paddingHorizontal: 16, marginVertical: 10 },
//   searchBox: {
//     flexDirection: 'row',
//     alignItems: 'center',
//     backgroundColor: '#FFF',
...
//   filterGrid: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', marginTop: 10, gap: 8 },
//   dropdownBtn: {
//     flexDirection: 'row',
//     alignItems: 'center',
//     backgroundColor: '#FFF',
...
//     borderColor: '#E0E0E0',
//   },
//   dropdownText: { fontSize: 12, color: '#424242', marginRight: 4 },
//   dateBtn: {
//     flexDirection: 'row',
//     alignItems: 'center',
//     backgroundColor: '#FFF',
...
//     borderColor: '#E0E0E0',
//   },
//   dateText: { fontSize: 12, color: '#424242', marginLeft: 4 },
//   clearDateBtn: { padding: 6 },
//   toggleGroup: { flexDirection: 'row', marginLeft: 'auto', backgroundColor: '#E0E0E0', borderRadius: 6, padding: 2 },
//   toggleBtn: { padding: 6, borderRadius: 4 },
//   activeToggle: { backgroundColor: '#0047AB' },
//   cardsContainer: { paddingHorizontal: 16 },
//   itemCard: { backgroundColor: '#FFF', borderRadius: 8, padding: 14, marginBottom: 12, elevation: 1 },
//   cardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
...
//     marginRight: 10,
//   },
//   avatarText: { color: '#0047AB', fontWeight: 'bold', fontSize: 13 },
//   userName: { fontSize: 14, fontWeight: 'bold', color: '#263238' },
//   userRole: { fontSize: 12, color: '#78909C' },
//   cardBodyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginVertical: 12 },
//   letterTag: { flexDirection: 'row', alignItems: 'center' },
//   letterTagText: { fontSize: 13, fontWeight: '600', color: '#0047AB', marginLeft: 6 },
//   statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
//   statusBadgeText: { fontSize: 11, fontWeight: 'bold' },
//   cardFooter: { borderTopWidth: 1, borderTopColor: '#F0F0F0', paddingTop: 8, flexDirection: 'row', justifyContent: 'space-between' },
//   dateLabel: { fontSize: 11, color: '#90A4AE' },
//   dateValue: { fontSize: 11, fontWeight: '600', color: '#455A64' },
//   tableScroll: { paddingHorizontal: 16 },
//   tableHeader: { flexDirection: 'row', backgroundColor: '#ECEFF1', paddingVertical: 10, paddingHorizontal: 8, borderRadius: 4 },
//   th: { fontSize: 11, fontWeight: 'bold', color: '#455A64' },
//   tableRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', paddingVertical: 10, paddingHorizontal: 8, borderBottomWidth: 1, borderBottomColor: '#F0F0F0' },
//   td: { flexDirection: 'row', alignItems: 'center' },
//   avatarSmall: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#E3F2FD', alignItems: 'center', justifyContent: 'center' },
//   avatarTextSmall: { color: '#0047AB', fontWeight: 'bold', fontSize: 11 },
//   tdBold: { fontSize: 12, fontWeight: 'bold', color: '#263238' },
//   tdSub: { fontSize: 10, color: '#78909C' },
//   tdText: { fontSize: 12, color: '#37474F' },
//   tdActions: { alignItems: 'center' },
//   modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' },
//   dropdownMenu: { width: '80%', backgroundColor: '#FFF', borderRadius: 8, padding: 8, elevation: 5 },
//   dropdownMenuItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: '#F5F5F5' },
//   menuItemText: { fontSize: 14, color: '#333' },
//   activeMenuText: { color: '#0047AB', fontWeight: 'bold' },
//   modalHeaderDark: { backgroundColor: '#0A1E3F', paddingHorizontal: 16, paddingVertical: 14, flexDirection: 'row', alignItems: 'center' },
//   formSectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#263238', marginBottom: 12 },
//   inputLabel: { fontSize: 12, fontWeight: 'bold', color: '#455A64', marginTop: 10, marginBottom: 4 },
//   formInput: { borderWidth: 1, borderColor: '#CFD8DC', borderRadius: 6, paddingHorizontal: 12, height: 40, fontSize: 13, color: '#263238' },
//   modalFooter: { flexDirection: 'row', padding: 16, borderTopWidth: 1, borderTopColor: '#ECEFF1', gap: 10 },
//   closeBtn: { flex: 1, height: 40, borderRadius: 6, backgroundColor: '#ECEFF1', alignItems: 'center', justifyContent: 'center' },
//   closeBtnText: { color: '#455A64', fontWeight: 'bold', fontSize: 13 },
//   submitBtn: { flex: 1, height: 40, borderRadius: 6, backgroundColor: '#0047AB', alignItems: 'center', justifyContent: 'center' },
//   submitBtnText: { color: '#FFF', fontWeight: 'bold', fontSize: 13 },
//   previewHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#ECEFF1' },
//   previewCard: { backgroundColor: '#FFF', borderRadius: 8, padding: 20, borderWidth: 1, borderColor: '#E0E0E0' },
//   companyTitle: { fontSize: 18, fontWeight: 'bold', color: '#0047AB', textAlign: 'center' },
//   divider: { height: 1, backgroundColor: '#E0E0E0', marginVertical: 12 },
//   dynamicLetterText: { fontSize: 13, color: '#37474F', lineHeight: 20 },
//   actionBtn: { flex: 1, flexDirection: 'row', height: 40, borderRadius: 6, borderWidth: 1, borderColor: '#CFD8DC', alignItems: 'center', justifyContent: 'center', gap: 6 },
//   actionBtnText: { color: '#37474F', fontWeight: 'bold', fontSize: 13 },
// });
        ...
        <View style={styles.controlsSection}>
          ...
          <View style={styles.filterGridContainer}>
            <View style={styles.filterRow}>
              <TouchableOpacity style={[styles.dropdownBtn, { flex: 1 }]} onPress={() => setShowTypeDropdown(true)}>
                <Text style={styles.dropdownText} numberOfLines={1}>{selectedType}</Text>
                <Feather name="chevron-down" size={14} color="#666" />
              </TouchableOpacity>

              <TouchableOpacity style={[styles.dropdownBtn, { flex: 1 }]} onPress={() => setShowStatusDropdown(true)}>
                <Text style={styles.dropdownText} numberOfLines={1}>{selectedStatus}</Text>
                <Feather name="chevron-down" size={14} color="#666" />
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.filterRow}>
              <TouchableOpacity style={[styles.dateBtn, { flex: 1 }]} onPress={() => setShowStartDatePicker(true)}>
                <Feather name="calendar" size={14} color="#666" />
                <Text style={styles.dateText} numberOfLines={1}>
                  {startDate ? startDate.toLocaleDateString('en-GB') : 'Start Date'}
                </Text>
              ...
              <TouchableOpacity style={[styles.dateBtn, { flex: 1 }]} onPress={() => setShowEndDatePicker(true)}>
                <Feather name="calendar" size={14} color="#666" />
                <Text style={styles.dateText} numberOfLines={1}>
                  {endDate ? endDate.toLocaleDateString('en-GB') : 'End Date'}
                </Text>
...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 4 },
  headerTextContainer: { flex: 1, marginLeft: 12, marginRight: 8 },
  headerTitle: { color: '#FFF', fontSize: 18, fontWeight: 'bold' },
  headerSubtitle: { color: '#90A4AE', fontSize: 12, flexShrink: 1, marginTop: 2 },
  createBtn: { backgroundColor: '#0047AB', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 6 },
  createBtnText: { color: '#FFF', fontWeight: 'bold', fontSize: 13 },
  metricsGrid: { flexDirection: 'row', flexWrap: 'wrap', padding: 8, justifyContent: 'space-between' },
  metricCard: {
    width: '48%',
  ...
  searchInput: { flex: 1, marginLeft: 8, fontSize: 13, color: '#333' },
  filterGridContainer: { marginTop: 10, gap: 8 },
  ...
  dropdownText: { fontSize: 12, color: '#424242', flex: 1, marginRight: 4 },
  dateBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#FFF',
  ...
  dateText: { fontSize: 12, color: '#424242', marginLeft: 6, flex: 1 },
  clearDateBtn: { padding: 6, justifyContent: 'center', alignItems: 'center' },
  toggleGroup: { flexDirection: 'row', backgroundColor: '#E0E0E0', borderRadius: 6, padding: 2, height: 38, alignItems: 'center' },
  toggleBtn: { paddingHorizontal: 8, paddingVertical: 6, borderRadius: 4 },
  activeToggle: { backgroundColor: '#0047AB' },
  cardsContainer: { paddingHorizontal: 16 },
  itemCard: { backgroundColor: '#FFF', borderRadius: 8, padding: 14, marginBottom: 12, elevation: 1 },
  cardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
