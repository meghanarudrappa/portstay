...
export default function DashboardScreen() {
  ...
  const [expandedMenus, setExpandedMenus] = useState<Record<string, boolean>>({
    leave: false,
    timeAttendance: false, // Opened by default based on image 1
    payroll: false
  })
        ...
        <View style={styles.drawerOverlay}>
          ...
          <View style={styles.drawerContentContainer}>
            ...
            <ScrollView style={styles.drawerScrollableMenu} showsVerticalScrollIndicator={false}>
              ...
              {/* Leave Accordion */}
              <TouchableOpacity style={[styles.menuItemRow, expandedMenus.leave && styles.activeActiveMenuBg]} onPress={() => toggleSubmenu('leave')}>
